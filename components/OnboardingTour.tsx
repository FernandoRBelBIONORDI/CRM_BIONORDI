...
const STEPS: StepDef[] = [
  ...
  /* 4 */ {
    ...
    why: "La cotización es el presupuesto formal que recibe el cliente antes de entregar el equipo. Sin cotización aprobada no se abre la Orden de Trabajo.",
    steps: [
      "En la tabla del CRM buscá la fila de 'Dr. Juan García (Tutorial)'.",
      "Al final de esa fila hacé click en el ícono de documento 📄.",
      "Aparecerá un selector con 4 tipos de cotización.",
      "Hacé click en la tarjeta 'Reparación de Transductores'.",
    ],
  ...
  /* 5 */ {
    ...
    icon: FileText, color: "#059669", bg: "#ECFDF5",
    why: "Los datos técnicos del equipo quedan registrados en la cotización y en el historial del cliente para toda referencia futura.",
    steps: [
      "En 'Tipo de transductor': desplegá y elegí 'Lineal'.",
      "Completá los campos Marca, Modelo, No. de Serie y Falla reportada con los datos de abajo.",
      "En el panel de servicios (izquierda) hacé click en el checkbox de 'Reparación transductor lineal'.",
    ],
    saveHint: "Cuando hayas marcado el servicio → hacé click en el botón verde 'Generar PDF' en la parte inferior.",
