...
export default function CRMPage() {
  ...
  return (
    <div className="h-full flex flex-col font-sans relative">
                      ...
                      <tr onClick={()=>{ setExpanded(isExp?null:lead.id); if(!isExp) loadInts(lead.id); }}
                        ...
                        <td onClick={e=>e.stopPropagation()} className="pb-4 pt-4 pr-1">
                          <div className="flex items-center justify-end gap-1 px-2">
                            ...
                            <button onClick={e=>{ e.stopPropagation(); setManualCotLead(lead); }}
                        ...
                        <div key={lead.id}
                          ...
                          <div className="flex items-center justify-between pt-2.5 border-t border-gray-100">
                            ...
                            <div className="flex gap-1.5">
                              ...
                              <button onClick={e=>{e.stopPropagation();setManualCotLead(lead);}} title="Cotizar"
      ...
      {/* Cotización Manual — mismo modal que el resto de la app */}
      {manualCotLead && (
        <>
          {/* Sentinel para detección del tutorial */}
