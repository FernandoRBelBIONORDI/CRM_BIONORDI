    ...
    <div className="h-full flex flex-col font-sans relative">
                      ...
                      <tr onClick={()=>{ setExpanded(isExp?null:lead.id); if(!isExp) loadInts(lead.id); }}
                        ...
                        <td onClick={e=>e.stopPropagation()} className="pb-4 pt-4 pr-1">
                          <div className="flex items-center justify-end gap-1 px-2">
                            ...
                            <button onClick={e=>{ e.stopPropagation(); setCotPickLead(lead); }}
                        ...
                        <div key={lead.id}
                          ...
                          <div className="flex items-center justify-between pt-2.5 border-t border-gray-100">
                            ...
                            <div className="flex gap-1.5">
                              ...
                              <button onClick={e=>{e.stopPropagation();setCotPickLead(lead);}} title="Cotizar"
      ...
      {cotPickLead && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/30 backdrop-blur-sm" onClick={() => setCotPickLead(null)}>
          <div className="bg-white rounded-[28px] shadow-[0_24px_60px_rgba(0,0,0,0.14)] w-full max-w-lg border border-gray-100" onClick={e => e.stopPropagation()}>
            <div className="px-7 pt-6 pb-5 border-b border-gray-100 flex items-center justify-between">
              <div>
                ...
                <p className="text-[12px] text-[#94A3B8] font-medium mt-0.5">
                  Cliente: <span className="text-[#4E60A9] font-bold">{cotPickLead.nombre}</span>
                </p>
              </div>
              <button onClick={() => setCotPickLead(null)} className="w-8 h-8 rounded-full flex items-center justify-center text-gray-400 hover:bg-gray-100 transition-colors"><X size={16}/></button>
            </div>
      ...
      {/* Cotización Manual — abierta desde el picker del CRM */}
      {manualCotLead && (
        <>
          ...
          <CotizacionManualModal
            ...
            initialLead={{
              id: manualCotLead.id,
              nombre: manualCotLead.nombre,
              telefono: manualCotLead.telefono,
              correo: manualCotLead.correo,
              ciudad: manualCotLead.ciudad,
              estado_republica: manualCotLead.estado_republica,
              direccion: manualCotLead.direccion,
            }}
          />
        </>
      )}
